...
import carevn.luv2code.cms.tevc_cms_api.configuration.TokenConfigurationParameter;
...
import carevn.luv2code.cms.tevc_cms_api.enums.TokenType;
...
import carevn.luv2code.cms.tevc_cms_api.util.ListUtil;
...
public class TokenServiceImpl implements TokenService {
    ...
    public Token generateToken(final Map<String, Object> claims) {
        ...
        final Date accessTokenExpiresAt = DateUtils.addMinutes(
                new Date(currentTimeMillis), tokenConfigurationParameter.getAccessTokenExpireMinute());
        ...
        final Date refreshTokenExpiresAt =
                DateUtils.addDays(new Date(currentTimeMillis), tokenConfigurationParameter.getRefreshTokenExpireDay());
    ...
    public UsernamePasswordAuthenticationToken getAuthentication(final String token) {
        ...
        final List<String> permissions =
                ListUtil.to(payload.get(TokenClaims.USER_PERMISSIONS.getValue()), String.class);
