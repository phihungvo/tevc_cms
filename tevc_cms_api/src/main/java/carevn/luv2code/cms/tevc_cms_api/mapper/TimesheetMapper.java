...
public interface TimesheetMapper {
    ...
    @Mapping(
            target = "employeeName",
            expression =
                    "java(timesheet.getEmployee() != null ? timesheet.getEmployee().getFirstName() + \" \" + timesheet.getEmployee().getLastName() : null)")
    ...
    @Mapping(
            target = "approverName",
            expression =
                    "java(timesheet.getApprover() != null ? timesheet.getApprover().getFirstName() + \" \" + timesheet.getApprover().getLastName() : null)")
