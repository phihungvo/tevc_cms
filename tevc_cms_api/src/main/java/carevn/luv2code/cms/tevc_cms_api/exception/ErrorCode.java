...
public enum ErrorCode {
    ...
    INVALID_PERMISSION_FORMAT(1025, "Invalid permission format", HttpStatus.BAD_REQUEST),
    EMPLOYEE_NOT_FOUND(1026, "Employee not found", HttpStatus.NOT_FOUND),
    EMPLOYEE_CODE_EXISTS(1027, "Employee code already exists", HttpStatus.CONFLICT),
    DEPARTMENT_NOT_FOUND(1028, "Department not found", HttpStatus.NOT_FOUND),
    DEPARTMENT_NAME_EXISTS(1029, "Department name already exists", HttpStatus.CONFLICT),
    DEPARTMENT_HAS_EMPLOYEES(1030, "Department has employees", HttpStatus.BAD_REQUEST),
    POSITION_NOT_FOUND(1031, "Position not found", HttpStatus.NOT_FOUND),
    POSITION_TITLE_EXISTS(1032, "Position title already exists", HttpStatus.CONFLICT),
    PROJECT_NOT_FOUND(1033, "Project not found", HttpStatus.NOT_FOUND),
    PROJECT_MANAGER_NOT_FOUND(1034, "Project manager not found", HttpStatus.NOT_FOUND),
    TIMESHEET_NOT_FOUND(1035, "Timesheet not found", HttpStatus.NOT_FOUND),
    TIMESHEET_ALREADY_PROCESSED(1036, "Timesheet already processed", HttpStatus.CONFLICT),
    CONTRACT_NOT_FOUND(1037, "Contract not found", HttpStatus.NOT_FOUND),
    CONTRACT_ALREADY_EXISTS(1038, "Contract already exists", HttpStatus.CONFLICT),
    CONTRACT_NOT_ACTIVE(1039, "Contract not active", HttpStatus.BAD_REQUEST),
    LEAVE_NOT_FOUND(1040, "Leave not found", HttpStatus.NOT_FOUND),
    LEAVE_ALREADY_PROCESSED(1041, "Leave already processed", HttpStatus.CONFLICT),
    PAYROLL_NOT_FOUND(1042, "Payroll not found", HttpStatus.NOT_FOUND),
    PAYROLL_ALREADY_EXISTS(1043, "Payroll already exists", HttpStatus.CONFLICT),
    PAYROLL_ALREADY_PROCESSED(1044, "Payroll already processed", HttpStatus.CONFLICT),
    PERFORMANCE_NOT_FOUND(1045, "Performance not found", HttpStatus.NOT_FOUND),
    REVIEWER_NOT_FOUND(1046, "Reviewer not found", HttpStatus.NOT_FOUND),
    ;
