...
public class KeyConverter {
    ...
    public PublicKey convertPublicKey(final String publicPemKey) {
        ...
        try {
            SubjectPublicKeyInfo publicKeyInfo =
                    SubjectPublicKeyInfo.getInstance(new PEMParser(keyReader).readObject());
    ...
    public PrivateKey convertPrivateKey(final String privatePemKey) {
        ...
        try {
            PrivateKeyInfo privateKeyInfo = PrivateKeyInfo.getInstance(new PEMParser(keyReader).readObject());
